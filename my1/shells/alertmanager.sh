...
install -m 0755 $TMPD/{alertmanager,amtool} /vagrant/configs/alertmanager/alertdump /usr/bin/
install -d -o alertmanager -g alertmanager /var/lib/alertmanager
install -m 0644 /vagrant/configs/alertmanager/{alertmanager,alertdump}.service /etc/systemd/system/
install -m 0644 -D /vagrant/configs/alertmanager/alertmanager.yml /etc/alertmanager/alertmanager.yml
