...
install -m 0644 /vagrant/ch03/configs/prometheus/prometheus.service /etc/systemd/system/
install -m 0644 -D /vagrant/ch03/configs/prometheus/prometheus.yml /etc/prometheus/prometheus.yml
install -m 0644 -D /vagrant/ch03/configs/prometheus/first_rules.yml /etc/prometheus/first_rules.yml
